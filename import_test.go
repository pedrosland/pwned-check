...
func TestLoadFilter(t *testing.T) {
	file := []byte{0x1f, 0x8b, 0x8, 0x4, 0x0, 0x0, 0x0, 0x0, 0x2, 0xff, 0xa, 0x0, 0x8, 0x1, 0x12, 0x6, 0x8, 0x1, 0x10, 0x2, 0x18, 0x8, 0x6a, 0x60, 0x60, 0x60, 0x61, 0x60, 0x60, 0x60, 0x0, 0x4, 0x0, 0x0, 0xff, 0xff, 0x73, 0xfc, 0x99, 0xc3, 0x8, 0x0, 0x0, 0x0}
	buf := bytes.NewBuffer(file)

	f, err := LoadFilter(context.Background(), buf)
	if err != nil {
...
func TestSaveFilter(t *testing.T) {
	...
	expected := []byte{0x1f, 0x8b, 0x8, 0x4, 0x0, 0x0, 0x0, 0x0, 0x2, 0xff, 0xa, 0x0, 0x8, 0x1, 0x12, 0x6, 0x8, 0x1, 0x10, 0x2, 0x18, 0x8, 0x6a, 0x60, 0x60, 0x60, 0x61, 0x60, 0x60, 0x60, 0x0, 0x4, 0x0, 0x0, 0xff, 0xff, 0x73, 0xfc, 0x99, 0xc3, 0x8, 0x0, 0x0, 0x0}
